...
public interface CartMapper {
    ...
    @Mapping(target = "selected", source = "item.selected")
    @Mapping(target = "weight", source = "item.variant.weight")
    @Mapping(target = "length", source = "item.variant.length")
    @Mapping(target = "width", source = "item.variant.width")
    @Mapping(target = "height", source = "item.variant.height")
    ...
    @Mapping(target = "originalPrice", expression = "java(resolveOriginalPrice(item))")
