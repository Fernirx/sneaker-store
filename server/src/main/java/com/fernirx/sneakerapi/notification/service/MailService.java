...
public interface MailService {
    ...
    void sendOrderVerificationOtp(String to, String username, String otpCode, int expiryMinutes);
    void sendOrderConfirmation(String to, String recipientName, String orderCode, BigDecimal totalAmount, String orderUrl);
}
