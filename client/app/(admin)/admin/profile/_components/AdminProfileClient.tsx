...
import AvatarUpload from '@/app/(store)/profile/_components/AvatarUpload';
import ProfileForm from '@/app/(store)/profile/_components/ProfileForm';
import ChangePasswordForm from '@/app/(store)/profile/_components/ChangePasswordForm';
import type { Profile } from '@/app/(store)/profile/_components/ProfileClient';
