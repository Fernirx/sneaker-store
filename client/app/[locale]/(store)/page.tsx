    ...
    <>
      ...
      <section className="bg-ink text-white">
        <div className="max-w-7xl mx-auto px-6 py-20 md:py-28">
          ...
          <p className="text-white/60 text-sm md:text-base mt-5 max-w-md">{t('heroSub')}</p>
      ...
      {newArrivals.length > 0 && (
        <section className="max-w-7xl mx-auto px-6 py-12">
          <SectionHeader title={t('newArrivalsTitle')} href="/products?newArrival=true" viewAllLabel={t('viewAll')} />
      ...
      {onSale.length > 0 && (
        <section className="max-w-7xl mx-auto px-6 py-12">
          <SectionHeader title={t('onSaleTitle')} href="/products?onSale=true" viewAllLabel={t('viewAll')} />
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
      ...
      {collections.length > 0 && (
        <section className="max-w-7xl mx-auto px-6 py-12">
          <SectionHeader title={t('collectionsTitle')} href="/products" viewAllLabel={t('viewAll')} />
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {collections.map(c => {
              const name = c.translations?.find(tr => tr.locale === locale)?.name ?? c.name;
              return (
                <Link
                  key={c.id}
      ...
      {brands.length > 0 && (
        <section className="bg-paper border-t border-line">
          <div className="max-w-7xl mx-auto px-6 py-12">
            <SectionHeader title={t('brandsTitle')} href="/products" viewAllLabel={t('viewAll')} />
