  ...
  const FilterPanel = (
    <div className="space-y-6">
      ...
      {brands && brands.length > 0 && (
        <div>
          <p className="text-[11px] font-bold uppercase tracking-wider text-muted mb-2">{"Thương hiệu"}</p>
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6">
      <div className="flex items-center justify-between mb-6">
        <p className="text-xs text-muted">{pageData.meta.totalElements} sản phẩm</p>
      ...
      <div className="flex gap-8">
          ...
          <div className="md:hidden fixed inset-0 z-40 flex">
            ...
            <div className="relative ml-auto w-72 max-w-full bg-white h-full overflow-y-auto p-5">
              <div className="flex items-center justify-between mb-4">
                <span className="font-display font-black text-sm uppercase tracking-wide">{"Lọc"}</span>
        ...
        <div className="flex-1 min-w-0">
          {pageData.data.length === 0 ? (
            <div className="py-20 text-center"><p className="text-muted">{"Không tìm thấy sản phẩm nào."}</p></div>
          ) : (
